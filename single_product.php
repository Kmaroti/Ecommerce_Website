...
$pdt_fetch = array(); // Initialize the variable here
...
$ctg_id = isset($pdt_fetch['ctg_id']) ? $pdt_fetch['ctg_id'] : null; // Handle the case when $pdt_fetch is null
...
$cmt_row = 0; // Initialize the variable
                                    ...
                                    <form action="addtocart.php" method="POST">
                                        ...
                                        <div class="sumary-product single-layout">
                                            ...
                                            <div class="product-attribute">
                                                ...
                                                <div class="price">
                                                    <ins><span class="price-amount"><span class="currencySymbol">&#8377. </span><?php echo $pro_data['pdt_price'] ?></span></ins>
