                     ...
                     <form class="shopping-cart-form" action="#" method="POST">
                                        ...
                                        <tr class="cart_item wrap-buttons">
                                            ...
                                            <form class="shopping-cart-form" action="#" method="POST">
                                                ...
                                                <td colspan="3">
                                                <img src="Pay.jpg" alt="Girl in a jacket" width="500" height="600">
                    ...
                    <div class="col-md-3">
                        <div class="shpcart-subtotal-block">
                            ...
                            <b class="stt-name">Payment <span class="sub"></span></b> 
                                <input type="text" style="border: none; width:100%;" placeholder="input Transaction ID" name="txid" required>
